...
(function (XQR) {
     ...
     * @internal
     */
    var fPatt = /function[^\(]*\(([a-zA-Z0-9_]+)[^\{]*\{([\s\S]*)\}$/m; //eslint-disable-line no-useless-escape
    /**
     * @internal
     */
     ...
     */
    var RetrieveRecord = /** @class */ (function () {
        function RetrieveRecord(entityPicker, id) {
            /**
             * @internal
             */
     ...
     */
    var RetrieveMultipleRecords = /** @class */ (function () {
        function RetrieveMultipleRecords(entityPicker) {
            /**
             * @internal
             */
        ...
        RetrieveMultipleRecords.prototype.getAll = function (successCallback, errorCallback) {
            var pages = []; //eslint-disable-line @typescript-eslint/no-explicit-any
            SDK.REST.retrieveMultipleRecords(this.logicalName, this.getOptionString(), function (page) {
                ...
                var _a;
                successCallback((_a = Array.prototype).concat.apply(_a, pages));
            });
        };
        /**
     ...
     */
    var UpdateRecord = /** @class */ (function () {
        function UpdateRecord(entityPicker, id, record) {
            this.logicalName = taggedExec(entityPicker).toString();
            this.id = id;
            this.record = record;
     ...
     */
    var DeleteRecord = /** @class */ (function () {
        function DeleteRecord(entityPicker, id) {
            this.logicalName = taggedExec(entityPicker).toString();
            this.id = id;
        }
