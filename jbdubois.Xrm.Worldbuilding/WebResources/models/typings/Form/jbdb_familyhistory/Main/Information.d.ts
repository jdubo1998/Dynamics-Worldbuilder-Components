declare namespace Form.jbdb_familyhistory.Main {
  namespace Information {
    ...
    interface Attributes extends Xrm.AttributeCollectionBase {
      ...
      get(name: "jbdb_family"): Xrm.LookupAttribute<"jbdb_family">;
    ...
    interface Controls extends Xrm.ControlCollectionBase {
      ...
      get(name: "jbdb_family"): Xrm.LookupControl<"jbdb_family">;
  ...
  interface Information extends Xrm.PageBase<Information.Attributes,Information.Tabs,Information.Controls,Information.QuickViewForms> {
    ...
    getAttribute(attributeName: "jbdb_family"): Xrm.LookupAttribute<"jbdb_family">;
    ...
    getControl(controlName: "jbdb_family"): Xrm.LookupControl<"jbdb_family">;
